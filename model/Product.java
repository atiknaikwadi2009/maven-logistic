...
public class Product implements Serializable {
	...
	/*
	 * For Tableview to display values
	 * use Properties with propertyValueFactory in the Controller class
	 * inside initialize()
	 */
...
//	private Set<Category> category;
	...
	public Product(String name, int quantity, double weight, double price, double purchasePrice, String category, double tax) {
	...
	public Product(int id, String name, int quantity, double weight, double price, double purchasePrice,
			String category, double tax) {
